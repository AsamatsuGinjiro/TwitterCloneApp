...
public class ExecuteLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (userInfoOnSession != null) {
			...
			//パラメータのバリデーションチェック
			if( !(validatePrmUserEmail(request.getParameter("EMAIL"))&&
				...
				UserDto        dto   = logic.executeSelectUserInfo(email, passWord);
	 ...
	 *詳細：入力値（名前）の検証を行う
	 *----------------------------------------------------------------------**/
	private boolean validatePrmUserEmail( String pr) {
